...
function simular()
{
	...
	var valor_unitario = 14441;  // Valor a a partir del 31/Enero/2023
		...
		for(i=1;i<=4;i++)
			...
			//if(eval(("form1.ano_espec"+i).value) > 0)
			{
				switch(i)
				{
					...
					case 2:
						{
							if (parseInt(form1.ano_espec2.value) >= 2)
								suma_no_clinica=30;
							else
								suma_no_clinica=20;
							break;
					...
					case 3:
						{
							if (parseInt(form1.ano_espec3.value) < 2)
								suma_magister=40;
							else
								suma_magister=60;
							break;
					...
					case 4:
						{
							if (parseInt(form1.ano_espec4.value) < 2)
								suma_doctorado=80;
							else
								suma_doctorado=120;
							break;
	...
	if (document.getElementsByName("escalafon")[0].checked==true) maximo_experiencia=20;
	if (document.getElementsByName("escalafon")[1].checked==true) maximo_experiencia=45;
	if (document.getElementsByName("escalafon")[2].checked==true) maximo_experiencia=90;
	if (document.getElementsByName("escalafon")[3].checked==true) maximo_experiencia=120;
	...
	if (document.getElementsByName("escalafon")[0].checked==true) maximo_productividad=80;
	if (document.getElementsByName("escalafon")[1].checked==true) maximo_productividad=160;
	if (document.getElementsByName("escalafon")[2].checked==true) maximo_productividad=320;
	if (document.getElementsByName("escalafon")[3].checked==true) maximo_productividad=540;
	...
	if (suma_total1!=suma_total2)
		...
		form1.valor_sueldo.value="aproximadamente de $"+formatAsMoney(Math.round(suma_total1*valor_unitario));
}
